...
class GaussianPolicy(LatentSpacePolicy):
    def __init__(self,
        ...
        self.test = tf.keras.Model(self.condition_inputs, shift_and_log_scale_diag)
        ...
        self.shift = tf.keras.Model(self.condition_inputs, shift)
        self.log_scale_diag = tf.keras.Model(self.condition_inputs, log_scale_diag)
        ...
        self.raw_act = tf.keras.Model(self.condition_inputs, raw_actions)
