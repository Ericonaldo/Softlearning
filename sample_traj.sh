# python simulate_policy.py --env=Hopper-v2 --num_rollouts=50
# python simulate_policy.py --env=Humanoid-v2 --num_rollouts=50
# python simulate_policy.py --env=HalfCheetah-v2 --num_rollouts=50
